...
public class BasicDoubleLinkedList_STUDENT_TEST {
		...
		public Car a=new Car("Toyota", "Sienna", 2021);
		public Car b=new Car("Volkswagen", "Golf", 2005);
		public Car c=new Car("Hyundai", "Sonata", 2005);
		public Car d=new Car("Porsche", "Spyder", 2005);
		public Car e=new Car("Ferrari", "spider", 2005);
		public Car f=new Car("Lexus", "RX", 2005);
		...
		public void setUp() throws Exception {
			...
			linkedString.addToEnd("Privet");
			linkedString.addToEnd("Mir");
		...
		public void testAddToEnd() {
			assertEquals("Mir", linkedString.getLast());
			linkedString.addToEnd("Konec");
			assertEquals("Konec", linkedString.getLast());
		...
		public void testAddToFront() {
			assertEquals("Privet", linkedString.getFirst());
			linkedString.addToFront("Nachalo");
			assertEquals("Nachalo", linkedString.getFirst());
		...
		public void testGetFirst() {
			assertEquals("Privet", linkedString.getFirst());
			linkedString.addToFront("Novyi");
			assertEquals("Novyi", linkedString.getFirst());
		...
		public void testGetLast() {
			assertEquals("Mir", linkedString.getLast());
			linkedString.addToEnd("Novyi");
			assertEquals("Novyi", linkedString.getLast());
		...
		public void testIteratorSuccessfulNext() {
			...
			assertEquals(true, iterator.hasNext());
			assertEquals("Konec", iterator.next());
		...
		public void testRetrieveFirstElement() {
			...
			linkedString.addToFront("Novyi");
			assertEquals("Novyi", linkedString.getFirst());
			assertEquals("Novyi", linkedString.retrieveFirstElement());
			assertEquals("Privet",linkedString.getFirst());
			assertEquals("Privet", linkedString.retrieveFirstElement());
			assertEquals("Mir",linkedString.getFirst());
		...
		public void testRetrieveLastElement() {
			...
			linkedString.addToEnd("Novyi");
			assertEquals("Novyi", linkedString.getLast());
			assertEquals("Novyi", linkedString.retrieveLastElement());
			assertEquals("Mir",linkedString.getLast());
		}
